define(
	function() {
		...
		Garage.prototype.types_match = function(a, b) {
		  return a.constructor === b.constructor;
		};

		Garage.prototype.get_values = function (obj) {
		  var lst = [];
		  for (var key in obj) {
		...
		Garage.prototype.draw = function() {
			...
			if (this.selected !== null) {
			  for (i = 0; i < this.equipment.length; i++) {
			    var fg = this.get_values(installed).some(function(a) { return this.types_match(this.equipment[i], a); }.bind(this)) ? "#999" : undefined;
