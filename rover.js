define(['instruction', 'basiccomponents'],
	function(Instruction, BasicComponents) {
		var Rover = function(x, y, logger, game) {
			...
			this.game = game;
			this.logger = logger;
			this.hardware = {0x0: new BasicComponents.SpeedControl(this),
			                 0x1: new BasicComponents.TurnControl(this),
			                 0x2: new BasicComponents.HeadingSensor(this)};
		};
